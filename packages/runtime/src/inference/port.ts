...
export type InferenceRequest = { maximumOutputTokens?: number; sections: readonly InferenceSection[]; manifest: InputManifest; deadlineAt: string; executionMode: "live" | "replay"; scope: { assistantId: string; sessionId: string; interactionId: string; endpointId: string | null } };
