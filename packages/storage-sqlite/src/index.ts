...
export type { CanonicalGrant, CanonicalHumanContext, TrustedGrantProposal, AuthorityCommand, AuthorityMutation, GrantOwnerBinding, CanonicalAdmission, CanonicalDispatchView } from './authority/canonical-grants.js';
