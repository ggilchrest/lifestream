...
Discovery separates Settings, Prepare sources, Topic briefs, Hypotheses, Candidates, Job history and Scoped feedback into mutually exclusive views. Preparation and bounded fixture analysis move directly to their observed job results. Briefs show selectable IDs, attribution, reliability, scope and freshness; source exclusion and topic forgetting require a nearby review and confirmation. Hypothesis analysis requires a topic and current approved evidence, then preserves competing tentative explanations and exact evidence references. Narrow tables become labeled cards. Scope changes clear source forms, records and pending retry identities. The development notice distinguishes supplied-source and fixture-analysis workflows from selected-provider qualification and comparison limits.
