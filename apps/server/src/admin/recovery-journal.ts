...
export class RecoveryJournal {
 ...
 forbidden(actor:string,relationshipId:string,value:string,sourceDigest?:string):boolean{return this.currency!=='current'||this.state.intents.some(i=>i.actor===actor&&i.relationshipId===relationshipId&&['delete-source','forget-derived-information','revoke-processing'].includes(i.action)&&(i.contentDigests.includes(recoveryDigest(value))||!!sourceDigest&&i.sourceDigests.includes(sourceDigest)));}
}
