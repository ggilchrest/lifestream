...
import { buildCanonicalPrompt, type RuntimeSelfContext } from "@lifestream/runtime/inference/prompt";
...
export async function streamMessage(response: ServerResponse, provider: InferenceProvider | undefined, body: Body, sessionId: string, aborted: AbortSignal, providerIdentity?: InferenceRuntimeIdentity, runtimeSelfContext?: RuntimeSelfContext): Promise<void> {
